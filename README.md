...
def listcomp_0x7ff31a16f0e0():
    __comp_temp=[]
    for c in .0:
        __comp_temp.append(c+5)
    return __comp_temp
def e():
    s=listcomp_0x7ff31a16f240(iter(s))
    o=listcomp_0x7ff31a16f2f0(iter(b(a(s),c(s))))
    return bytes(o)
def listcomp_0x7ff31a16f240():
    __comp_temp=[]
    for c in .0:
        __comp_temp.append(ord(c))
    return __comp_temp
def listcomp_0x7ff31a16f2f0():
    __comp_temp=[]
    for c in .0:
        __comp_temp.append((c^5)-30)
    return __comp_temp
def main():
    s=input('Guess?')
